...
You must utilize the xdelta patch to generate a good rom for Assembly. To generate xdelta executables, run this:

`./pull_xdelta`

You must place your legally acquired patched ROM in the 'roms' folder for this to work. It must be named ssb.rom. Run this to build:

`./build_z64 -f '<PATH_TO_LEGALLY_ACQUIRED_ROM>'`
